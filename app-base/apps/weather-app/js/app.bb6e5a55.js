  ...
  NHnr: function(e, t, r) {
    ...
    var n = r("/5sW"),
      ...
      a = function() {
        ...
        }, [e._v(e._s(e.location))]), e._v(" "), r("div", {
          staticClass: "weather__description"
        }, [e._v(e._s(e.description))]), e._v(" "), r("img", {
      ...
      f = {
        ...
        methods: {
          ...
          toggleTemperature: function() {
            "Celcius" === this.scale ? this.scale = "Fahrenheit" : this.scale = "Celcius"
          }
        }
      },
      v = function() {
        ...
        return n("section", [n("div", {
          staticClass: "temperature__value"
        }, [e._v(e._s("C" === e.scaleSymbol ? e.value : e.fValue))]), e._v(" "), n("div", {
          staticClass: "temperature__right"
        }, [n("div", {
          staticClass: "temperature__scale"
        }, [n("a", {
          attrs: {
            href: "#"
          },
        ...
        }, [e._v("°" + e._s(e.scaleSymbol))])]), e._v(" "), n("div", {
          staticClass: "temperature__high"
        }, [n("img", {
          attrs: {
            src: r("aF19"),
            alt: "high temperature"
          }
        }), n("span", [e._v(e._s("C" === e.scaleSymbol ? e.high : e.fHigh))]), e._v("°\n        ")]), e._v(" "), n("div", {
          staticClass: "temperature__low"
        }, [n("img", {
          attrs: {
            src: r("ickf"),
            alt: "low temperature"
          }
        }), n("span", [e._v(e._s("C" === e.scaleSymbol ? e.low : e.fLow))]), e._v("°\n        ")])])])
      },
      _ = [];
    ...
    var y = !1,
      ...
      A = function() {
        ...
        return n("section", [n("div", {
          ...
          staticClass: "cloudiness__value"
        }, [e._v(e._s(e.cloudiness))]), e._v("%\n    ")]), e._v(" "), n("div", {
          staticClass: "wind-speed"
        }, [n("img", {
          attrs: {
            src: r("cUAQ"),
            alt: "wind speed"
          ...
          staticClass: "wind__value"
        }, [e._v(e._s(e.windSpeed))]), e._v("m/s\n    ")]), e._v(" "), n("div", {
          ...
          staticClass: "humidity__value"
        }, [e._v(e._s(e.humidity))]), e._v("%\n    ")])])
      },
      S = [];
    ...
    var T = !1,
      ...
      $ = function() {
        function e() {
          L()(this, e), this.cloudiness = 0, this.windSpeed = 0, this.humidity = 0, this.temperatureValue = 0, this.temperatureHigh = 0, this.temperatureLow = 0, this.location = " ", this.description = "Please connect to internet to fetch latest forecast :)", this.weatherIcon = r("Tavs"), this.update()
        }
        return O()(e, [{
          key: "update",
          value: function() {
            var e = this;
            navigator.onLine && navigator.geolocation.getCurrentPosition(function(t) {
            ...
            var e = R()(regeneratorRuntime.mark(function e(t) {
              ...
              return regeneratorRuntime.wrap(function(e) {
                while (1) switch (e.prev = e.next) {
                  case 0:
                    return r = null, e.prev = 1, e.next = 4, this.getForecast(t.coords);
                  case 4:
                    r = e.sent, e.next = 10;
                    break;
                  case 7:
                    e.prev = 7, e.t0 = e["catch"](1), r = this.getErrorData();
                  case 10:
                    this.populate(r);
                  case 11:
                  case "end":
          ...
          value: function() {
            var e = R()(regeneratorRuntime.mark(function e(t) {
              ...
              return regeneratorRuntime.wrap(function(e) {
                while (1) switch (e.prev = e.next) {
                  case 0:
                    return r = "a3e7bdc246b811691b06aab13ccb0dbb", n = "https://api.openweathermap.org/data/2.5/weather?lat=".concat(t.latitude, "&lon=").concat(t.longitude, "&appid=").concat(r, "&units=metric"), e.next = 4, fetch(n);
                  case 4:
    ...
    var U = !1,
      ...
      ee = function() {
        var e = this,
          t = e.$createElement,
          r = e._self._c || t;
        return r("footer", [r("small", [e._v(""), e._m(0), e._v("" + e._s("") + ""), r("", [e._v("")]), e._v("")])])
      },
      te = [function() {
        var e = this,
          t = e.$createElement,
    ...
    var de = !1,
      ...
      ge = _e.exports,
      ye = r("ydGU");
    Object(ye["a"])("".concat("/progressive-weather-app/", "service-worker.js"), {
      ready: function() {
